...
<div class="col-md-12">  
    <div class="panel panel-primary">
        <div class="panel-heading"><b>Add edit news</b></div>
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="checkbox" <?php if(isset($record->hot)&&$record->hot==1): ?> checked <?php endif; ?> name="hot" id="hot"> <label for="hot">&nbsp;&nbsp;Tin tức nổi bật</label>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
