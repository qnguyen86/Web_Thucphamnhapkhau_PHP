...
<html lang="en">
    ...
    <style type="text/css">
        .bg-template{background: url('../assets/admin/assets/img/Natural-2.jpg');}
    </style>
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="index.php?controller=users&action1=create1">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
